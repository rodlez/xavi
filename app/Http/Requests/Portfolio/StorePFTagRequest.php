...
class StorePFTagRequest extends FormRequest
{
    /**
    ...
    {        
        return [
            'name' => 'bail|required|min:3|string|' . Rule::unique('pf_tags')->ignore($this->tag),
    ...
    public function messages(): array
    {
        ...
        if ($language == 'en') {
            return [
                ...
                'name.min' => 'The tag name must have at least :min characters',
                'name.unique' => 'This tag is already created',
