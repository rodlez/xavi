<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500 capitalize">
        <a href="/admin/pf_types"
            class="text-black {{ $textMenuHeader }}">{{ __('admin/portfolio/portfolioTypes.menuIndex') }}</a> /
        <a href="/admin/pf_types/create" class="font-bold text-black {{ $underlineMenuHeader }}">{{ __('generic.new') }}</a>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="mx-auto w-11/12 py-4 px-2">
            ...
            <div class="flex w-full sm:w-fit text-lg text-white bg-green-600 font-light normal-case rounded-t-md p-2">
                <span>{{ __('admin/portfolio/portfolioTypes.infoMessageCreate') }}</span>
            </div>
                ...
                <form wire:submit="save">
                    ...
                    <div class="flex flex-col py-2">
                        ...
                        <div class="bg-slate-800 rounded-md p-2">
                            <span
                                class="text-sm text-white normal-case">{{ __('generic.noTranslationMessage') }}</span>
                        </div>
                    </div>
        ...
        <div
            ...
            <div class="w-1/3 text-left"><a href="{{ route('pf_types') }}">
