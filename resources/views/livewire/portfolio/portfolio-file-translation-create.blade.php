<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500 capitalize">
        ...
        <a href="/portfolios/{{ $file->portfolio->id }}/file/{{ $file->id }}/create"
            class="font-bold text-black {{ $underlineMenuHeader }}">{{ __('generic.create') }}</a>
    </div>
...
{{var_dump($file)}}
        ...
        <div
            ...
            <div class="w-1/3 text-left"><a href="{{ route('portfoliosfile.show', [$this->file->portfolio, $this->file]) }}">
