<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500 capitalize">
        <a href="{{route('pf_tags')}}" class="{{ $textMenuHeader }}">{{ __('admin/portfolio/portfolioTags.menuIndex') }}</a> /
        <a href="{{route('pf_tags.show', $translation->tag)}}" class="{{ $textMenuHeader }}">{{ $translation->tag->name }}</a> /
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="mx-auto w-11/12 my-4 px-2">
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-col text-black capitalize bg-slate-200 rounded-b-lg sm:rounded-tr-lg">
                    ...
                    <span class="text-sm normal-case p-2">{{ $translation->tag->description ? $translation->tag->description : '-' }}</span>
                </div>
        ...
        <div
            ...
            <div class="w-1/3 text-left"><a href="{{ route('pf_tags.show', $translation->tag) }}">
