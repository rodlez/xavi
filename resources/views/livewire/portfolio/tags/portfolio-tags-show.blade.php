<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500 capitalize">
        ...
        <a href="/pf_tags/{{ $tag->id }}" class="font-bold text-black {{$underlineMenuHeader}}">{{__("generic.info")}}</a>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="flex flex-row justify-between items-center py-4 {{$bgMenuColor}}">
            <div>
                <span class="text-lg text-white capitalize px-4">{{__("admin/portfolio/portfolioTags.titleHeader")}} - {{ $tag->name }}</span>
            </div>
        </div>
                            ...
                            <tr class="bg-white border-b text-center">
                                ...
                                <td class="p-2">
                                    <div class="flex justify-center items-center gap-2">
                                        <!-- Edit -->
                                        <a href="{{ route('pf_tags_trans.edit', $translation) }}" title="{{__("generic.edit")}}">
                                            <i
