<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500">
        ...
        <a href="/pf_categories/create" class="font-bold text-black border-b-2 border-b-blue-800">New</a>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="mx-auto w-11/12 py-4 px-2">
            ...
            <div class="italic p-2 rounded-md bg-blue-100">Create a new PortFolio Category, description is optional.
            </div>
