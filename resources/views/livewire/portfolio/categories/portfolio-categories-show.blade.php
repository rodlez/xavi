<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row justify-start items-start gap-1 text-sm py-3 px-4 text-slate-500 capitalize">
        ...
        <a href="/admin/pf_categories/{{ $category->id }}"
            class="font-bold text-black {{ $underlineMenuHeader }}">{{ $category->name }}</a>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="flex flex-row justify-start items-center py-4 {{ $bgMenuColor }}">
            <span class="text-lg text-white capitalize px-4">{{ __('generic.portfolio') }} {{ __('generic.category') }}</span>
        </div>
        ...
        <div class="mx-auto w-11/12 my-4 px-2">
            ...
            <div class="flex flex-col capitalize">
                ...
                <div class="flex flex-col text-black bg-gray-100">
                    ...
                    <span class="p-2 normal-case">{{ $category->description ? $category->description : '-' }}</span>
                </div>
