<div class="max-w-7xl mx-auto sm:pb-8 sm:px-6 lg:px-8">
    ...
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <div class="mx-auto w-11/12 py-4 px-2">
            ...
            <div>
                <div>Translations for this Category -> {{ $category->translations->count() }}</div>
                <div>Total Languages -> {{ $totalLanguages }}</div>

                @foreach ($category->translations as $translation)
                    <div><strong>Translation</strong> {{ $translation->name }}
                        <strong>Language</strong> {{ $translation->language->name }} <strong>Code</strong>
                ...
                @if ($category->translations->count() < $totalLanguages)
