    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex capitalize">                    
                    ...
                    <x-nav-link href="{{ route('pf_tags') }}" :active="request()->routeIs('pf_tags')">
                        {{ __('PF Tags') }}
                    </x-nav-link>

                    <x-nav-link href="{{ route('pf_tags_trans') }}" :active="request()->routeIs('pf_tags_trans')">
                        {{ __('PF Tags Trans') }}
                    </x-nav-link> --}}
                        ...
                        <x-dropdown align="right" width="40">
                            <x-slot name="trigger">
                                ...
                                <button
                                    ...
                                    <div class="capitalize">{{ __('generic.portfolio') }} 
                                       {{--  {{request()->routeIs('portfolios') ? ' pfs' : ''}} --}}
                                    </div>
                            ...
                            <x-slot name="content">
                                <x-dropdown-link href="{{ route('portfolios') }}" :active="request()->routeIs('portfolios')">
                                    {{ __('generic.portfolios') }}
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('pf_types') }}" :active="request()->routeIs('pf_types')">
                                    {{ __('generic.type') }}
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('pf_categories') }}" :active="request()->routeIs('pf_categories')">
                                    {{ __('generic.categories') }}
                                </x-dropdown-link>
                                <x-dropdown-link href="{{ route('pf_tags') }}" :active="request()->routeIs('pf_tags')">
                                    {{ __('generic.tags') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
                        ...
                        <x-dropdown align="right" width="40">
                            <x-slot name="trigger">
                                <button
                                    ...
                                    <div class="capitalize">{{ __('generic.language') }}:
                                        {{ $languages[Session::get('locale', 'es')] }}</div>
