<footer class="container mx-auto p-4 text-sm border-t flex justify-between items-center">
    <div>Xavrod - © {{ date('Y') }}</div>
    @env('local')
    <div class="p-2 bg-gray-200 rounded-md" x-data="{showIcons: false}"
...
oli
                {{-- <x-layout.xavifooter-icon target="_mail"
                                      href="http://localhost:8025"
                                      icon="si-maildotru"/>
                <x-layout.xavifooter-icon target="_icons"
                                      href="https://blade-ui-kit.com/blade-icons"
                                      icon="fas-icons"/>
                <x-layout.xavifooter-icon target="_tall" 
    ...
    {{-- Icons test --}}
    <div>
    <x-layout.xavifooter-icon target="_mail" href="http://localhost:8025" icon="fa-brands fa-facebook" />
    <x-layout.xavifooter-icon target="_icons" href="https://blade-ui-kit.com/blade-icons" />
    <x-layout.xavifooter-icon target="_tall" href="https://tailwindcss.com/docs" />
    </div>
