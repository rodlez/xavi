...
@switch($file->media_type)
    ...
    @case('application/pdf')
        <a href="{{ asset('storage/' . $file->path) }}" title="{{ __('generic.open') }} PDF" target="_blank">
    ...
    @case('image/jpeg')
        <a href="{{ asset('storage/' . $file->path) }}" title="{{ __('generic.show') }} {{ __('generic.image') }}" target="_blank">
            @if ($imagesBig)
