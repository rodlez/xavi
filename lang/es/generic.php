...
return [
    ...
    "missingResponsive" => "Aún no hay ninguna imagen responsive",
    "missingResponsiveImage" => "Imagen responsive pendiente",
    "missingResponsiveImages" => "Imágenes responsive pendientes",    
    // DOCUMENTS
